...
test('IRT decoding', async () => {
  const tokenString = '.eyJpc3MiOiJodHRwczovL2lzc3Vlci5leGFtcGxlLm9yZyIsInN1YiI6InN1YmplY3QiLCJhdWQiOiJhdWRpZW5jZSIsImlhdCI6MTY3OTYxMjQwMCwiZXhwIjoxNjc5NjE2MDAwfQ.HKzMC_giMs2Jo5MQ8mwoAr2INix3hLM_SwGQxClYwbLSrswTpl1xdtEzBKF2YwBerhAE04-lpha9w-7BepMAuD4KEAMaAd8ZsDCQW2pPz7dC5r2kusQHlkv_-bt_qVPjUbbV6jVp_S2ixSaM5Wyq0FgmFZ8uOFw1epRoxM8ViLyucSzlq2DcmjcH_v4WZ6E2s12Te_sYxJ-lV70vkUAD971oLNzBnxdiz-vYjAzMibyx4R9TIqYagak_KDVXfy-uKzRnh_nNHMOdwm-eGnqIhxHVjuWHy4-yxhxiUHypRGLvIxm0qeXsRc1ThG4Mc3xf_FTcS9nUGw9p1Tf2ouQazA';

  async () => expect(IctRequestToken.fromTokenString(tokenString)).rejects.not.toThrow();
  expect(await IctRequestToken.fromTokenString(tokenString, false)).toBeInstanceOf(IctRequestToken);
  expect(await (await IctRequestToken.fromTokenString(tokenString, false)).getTokenString()).toBe(tokenString);

  const tokenStringWithoutHeader = '.eyJpc3MiOiJodHRwczovL2lzc3Vlci5leGFtcGxlLm9yZyIsInN1YiI6InN1YmplY3QiLCJhdWQiOiJhdWRpZW5jZSIsImlhdCI6MTY3OTYxMjQwMCwiZXhwIjoxNjc5NjE2MDAwfQ.HKzMC_giMs2Jo5MQ8mwoAr2INix3hLM_SwGQxClYwbLSrswTpl1xdtEzBKF2YwBerhAE04-lpha9w-7BepMAuD4KEAMaAd8ZsDCQW2pPz7dC5r2kusQHlkv_-bt_qVPjUbbV6jVp_S2ixSaM5Wyq0FgmFZ8uOFw1epRoxM8ViLyucSzlq2DcmjcH_v4WZ6E2s12Te_sYxJ-lV70vkUAD971oLNzBnxdiz-vYjAzMibyx4R9TIqYagak_KDVXfy-uKzRnh_nNHMOdwm-eGnqIhxHVjuWHy4-yxhxiUHypRGLvIxm0qeXsRc1ThG4Mc3xf_FTcS9nUGw9p1Tf2ouQazA';
  async () => expect(IctRequestToken.fromTokenString(tokenStringWithoutHeader)).rejects.toThrow();
  const tokenStringWithoutPayload = '..HKzMC_giMs2Jo5MQ8mwoAr2INix3hLM_SwGQxClYwbLSrswTpl1xdtEzBKF2YwBerhAE04-lpha9w-7BepMAuD4KEAMaAd8ZsDCQW2pPz7dC5r2kusQHlkv_-bt_qVPjUbbV6jVp_S2ixSaM5Wyq0FgmFZ8uOFw1epRoxM8ViLyucSzlq2DcmjcH_v4WZ6E2s12Te_sYxJ-lV70vkUAD971oLNzBnxdiz-vYjAzMibyx4R9TIqYagak_KDVXfy-uKzRnh_nNHMOdwm-eGnqIhxHVjuWHy4-yxhxiUHypRGLvIxm0qeXsRc1ThG4Mc3xf_FTcS9nUGw9p1Tf2ouQazA';
  async () => expect(IctRequestToken.fromTokenString(tokenStringWithoutPayload)).rejects.toThrow();
  const tokenStringWithoutSignature = '.eyJpc3MiOiJodHRwczovL2lzc3Vlci5leGFtcGxlLm9yZyIsInN1YiI6InN1YmplY3QiLCJhdWQiOiJhdWRpZW5jZSIsImlhdCI6MTY3OTYxMjQwMCwiZXhwIjoxNjc5NjE2MDAwfQ.';
  async () => expect(IctRequestToken.fromTokenString(tokenStringWithoutSignature)).rejects.toThrow();
});
